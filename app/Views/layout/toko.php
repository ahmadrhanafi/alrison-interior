        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-sm text-white mr-2" style="background-color: #333333;" type="button" data-dismiss="modal">Kembali</button>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-footer-widget">
                        ...
                        <p class="mb-3" style="font-size: medium; color:#cccccc;">Jln. Raya Parung Bogor Kp. Jati, RT. 02/07, Parung, Kecamatan Parung, Kabupaten Bogor, Jawa Barat 16330.</p>
                        <!-- Footer Social Area-->
                        <div class="footer_social_area mt-5">
                            ...
                            <a href="https://api.whatsapp.com/send/?phone=%2B6289657951760" data-toggle="tooltip" data-placement="top" title="" data-original-title="WhatsApp"><i class="fab fa-whatsapp" style="color: #c80000;"></i></a>
                        </div>
                        <!-- Copywrite Text-->
                        <!-- <div class="copywrite-text mt-5 mb-3">
