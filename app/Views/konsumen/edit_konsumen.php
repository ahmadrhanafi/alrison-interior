    ...
    <div class="container">
        <di class="row">
            <div class="col-10 mx-auto mt-4">
                <h2 class="py-3">Edit konsumen</h2>

                <form action="update_konsumen" method="post">
                    <input type="hidden" class="form-control" id="id_konsumen" name="id_konsumen" value="<?= $konsumen['id_konsumen']; ?>">
                    <?= csrf_field(); ?>
                    <div class="mb-3">
                        <label for="namaKonsumen" class="form-label">Nama Konsumen</label>
                        <input type="text" class="form-control" id="namaKonsumen" name="nama_konsumen" required value="<?= $konsumen['nama_konsumen']; ?>">
                    </div>
                    <!-- <div class="mb-3">
                        <label for="transaksi" class="form-label">Transaksi</label>
                        <input type="text" class="form-control" id="transaksi" name="transaksi" value="<?= $konsumen['transaksi']; ?>">
                    </div> -->
                    <div class="mb-3">
                        <label for="no_hp" class="form-label">Nomor Handphone</label>
                        <input type="number" class="form-control" id="no_hp" name="no_hp" value="<?= $konsumen['no_hp']; ?>">
                    </div>
                    <div class="mb-3">
